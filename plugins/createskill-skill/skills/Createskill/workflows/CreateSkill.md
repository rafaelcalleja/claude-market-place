...
1. Read the skill system documentation: `${CLAUDE_PLUGIN_ROOT}/skills/Createskill/references/SkillSystem.md`
2. Read the canonical example: `${CLAUDE_PLUGIN_ROOT}/skills/Createskill/references/BloggingExample.md`
...
```bash
mkdir -p [target-path]/skills/[SkillName]/workflows
...
Run this check:
```bash
ls [target-path]/skills/[SkillName]/
