...
```
${CLAUDE_PLUGIN_ROOT}/skills/Createskill/references/SkillSystem.md
```
...
```bash
[target-path]/skills/[SkillName]/SKILL.md
```
...
```bash
touch [target-path]/skills/[SkillName]/workflows/[WorkflowName].md
```
...
```bash
touch [target-path]/skills/[SkillName]/tools/ToolName.ts
touch [target-path]/skills/[SkillName]/tools/ToolName.help.md
```

2. **Ensure tools/ directory exists:**
```bash
mkdir -p [target-path]/skills/[SkillName]/tools
```
...
```bash
ls [target-path]/skills/[SkillName]/workflows/
ls [target-path]/skills/[SkillName]/tools/
```

All files must use TitleCase:
- Correct: `WorkflowName.md`
- Correct: `ToolName.ts`, `ToolName.help.md`
- Wrong: `workflow-name.md`, `tool_name.ts`
