...
| Review Environments | Dynamically created environments in your cloud, hosting your development in progress. It is a strict equivalent of GitLab's [Review Apps](https://docs.gitlab.com/ci/review_apps/) feature. |
...
*   or [`include:remote`](https://docs.gitlab.com/ci/yaml/#includeremote):
    ...
    ```
    ℹ _this technique might only be of interest if you want to test _to be continuous_ from your Self-Managed GitLab without installing it locally_